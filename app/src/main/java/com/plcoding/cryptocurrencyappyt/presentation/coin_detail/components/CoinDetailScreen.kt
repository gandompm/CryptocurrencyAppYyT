...
import com.plcoding.cryptocurrencyappyt.presentation.coin_detail.CoinDetailsViewModel
        ...
        LazyColumn(modifier = Modifier.fillMaxSize(), contentPadding = PaddingValues(20.dp)){
            item {
                Row(
                    ...
                    Text(text = if (coin.isActive) "active" else "inactive", color = if(coin.isActive) Color.Green
                    else Color.Red, fontStyle = FontStyle.Italic, textAlign = TextAlign.End, modifier = Modifier
